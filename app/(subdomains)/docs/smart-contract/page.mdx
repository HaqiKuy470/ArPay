...
<div className="grid grid-cols-1 gap-1 my-3">
  <div className="flex items-center gap-2 text-sm text-slate-400"><span className="text-green-400">✅</span> Merchant ID length ≤ 25 characters</div>
  ...
  <div className="flex items-center gap-2 text-sm text-slate-400"><span className="text-green-400">✅</span> Payer token account has sufficient USDC balance</div>
...
<div className="flex flex-col gap-2 my-3">
  <div className="flex items-start gap-3 text-sm">
    ...
    <span className="text-slate-400">Merchant ID empty or too long</span>
  </div>
  <div className="flex items-start gap-3 text-sm">
  ...
  <div className="flex items-start gap-3 text-sm">
    ...
    <span className="text-slate-400">Payer token account balance too low</span>
  </div>
  <div className="flex items-start gap-3 text-sm">
...
```
  ...
  <div className="border border-white/10 rounded-lg p-4 bg-white/5">
    <div className="text-xs font-mono text-yellow-400 font-bold mb-3 uppercase tracking-wider">Payer Refund</div>
...
<div className="flex flex-col gap-2 my-3">
  ...
  <div className="flex items-start gap-3 text-sm">
    ...
    <span className="text-slate-400">Current time is less than escrow creation time + timeout (if `to_treasury=false`)</span>
  </div>
  <div className="flex items-start gap-3 text-sm">
